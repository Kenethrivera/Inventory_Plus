                        ...
                        SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            onChanged: (val) {
                              setState(
                                () => item.customPrice =
                                    double.tryParse(val) ?? item.product.price,
                              );
                            },
                          ),
                        ),
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Divider(),
                  Text(
                    'Total Items: ${cart.fold<int>(0, (sum, item) => sum + item.quantity)}',
                  ),
                  const SizedBox(height: 16),
                  Text(
                    'Total Price: \$${cartTotal.toStringAsFixed(2)}',
